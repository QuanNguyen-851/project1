...
<div id="main">
    ...
    <div id="content">
        <div class="banner">
            <div class="container">
                <div class="anh">
                    <img src="../anh/1_1067x600-800-resize.jpg">
                    <img src="../anh/linh-kien-may-tinh-gom-nhung-gi-1024x304.jpg">
                    <img src="../anh/huong-dan-cach-lua-chon-linh-kien-de-build-pc-chuan-nhat-.gif">
                    <img src="../anh/phu-kien-2020-phong-vu-1.jpg">
                </div>
                <div class="nut">
                    <i class="fas fa-chevron-left" onclick="Back();"></i>
                    <i class="fas fa-chevron-right" onclick="Next();"></i></div>
