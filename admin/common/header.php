...
<body>
	...
	<div style="position: fixed;background: #4d4d4d;width: 20%;height: 710px;margin-top: 50px;display: none;" id="menu">
		<ul>
			<li><a class="header" href="main.php">Sản phẩm</a></li>
			<li><a class="header" href='?command=1'>Thiết lập cá nhân</a></li>
			<?php if($quyen == 1){ ?>
				<li><a class="header" href='?command=2'>Quản lí tài khoản</a></li> <?php } ?>
			<li><a class="header" href="dang_xuat.php">Đăng xuất</a></li>
		</ul>
	</div>
