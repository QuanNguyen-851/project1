...
<body>
	...
	<div id='margin' style="margin-left: 5%;margin-top: 5%;border-left: 1px solid black;border-top: 1px solid black;height: 710px;background: #666666">
		<div style="height: 50px;width: 100%;background: #333333;margin-bottom: 0;display: flex;">
			<?php if($quyen == 1){ ?>
			<a style="color: white" class="thongtin" href="../common/main.php?command=2">Quay lại</a> <?php } else { ?>
			<a style="color: white" class="thongtin" href="../common/main.php">Quay lại</a> <?php } ?>
			<a class="thongtin" href="<?php if(isset($_GET['ma'])){ ?>../common/main.php?command=1&ma=<?php echo $ma;
				} else {
				echo "../common/main.php?command=1"; } ?>">Thông tin tài khoản</a>
			<a class="thongtin" href="<?php if(isset($_GET['ma'])){ ?>../common/main.php?command=1&tab=1&ma=<?php echo $ma;
				} else {
				echo "../common/main.php?command=1&tab=1"; } ?>">Đổi mật khẩu</a>
		</div>
		<?php
 				   ...
 				   switch ($command) {
  				    ...
  				    if ($quyen == 1 && $tk!=$thongtin['userName']) {
  				    	...
  				    	?>
  				    	<form action="../process/doi-mk.php?quyen&ma=<?php echo $ma; ?>" method="post">
 		...
 		<?php 
 					...
 					?>
  				    	<form action="../process/doi-mk.php?ma=<?php echo $thongtin['maAdmin']; ?>" method="post">
	...
	?>../process/doi-thong-tin.php?ma=<?php echo $_GET['ma']; } else { ?> ../process/doi-thong-tin.php?Ma=<?php echo $thongtin['maAdmin'];
			} ?>" method='post'>
 				<table style="margin-left: 35%;margin-top: 50px;" border="0">
 					<tr>
