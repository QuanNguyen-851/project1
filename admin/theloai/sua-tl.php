...
<body>
	...
	<div id='margin' style="margin-left: 3%;margin-top: 5%;border-left: 1px solid black;border-top: 1px solid black;height: 700px;background: white">
		<div style="height: 50px;width: 100%;background: #333333;margin-bottom: 0;display: flex;border-bottom: 2px solid black">
			<a style="color: white" class="thongtin" href="../common/main.php?command=4">Quay lại</a>
		</div>
		<center><h1 style="font-size: 50px;">Sửa thể loại</h1></center>
		<div style="margin-top: 80px;width: 100%">

	<center><form style="border: 1px solid black;margin-right: 500px;margin-left: 500px;" action="../process/sua-tl.php?ma=<?php echo $ma; ?>" method="POST">
			<p style="margin-top: 50px;font-size: 30px">Tên thể loại: <input style="height: 30px;font-size: 20px" type="text" name="hang" value="<?php echo $ten; ?>"></p><br/><br/>
