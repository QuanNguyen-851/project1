...
if ($check == 0) {
	...
	} else { header("location:../common/main.php?command2&error=4");
	}
} else {
	header("location:../common/main.php?command=2&error=2");
}
	} else {
	header("location:../common/main.php?command=2&error=1");
}
 } else {
	header("location:../common/main.php?command=2&error=3");
}
